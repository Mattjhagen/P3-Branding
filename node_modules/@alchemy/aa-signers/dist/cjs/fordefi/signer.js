...
exports.FordefiSigner = void 0;
const aa_core_1 = require("@alchemy/aa-core");
const web3_provider_1 = require("@fordefi/web3-provider");
...
class FordefiSigner {
    constructor(params) {
        ...
        Object.defineProperty(this, "signerType", {
            ...
            configurable: true,
            writable: true,
            value: `${constants_js_1.signerTypePrefix}fordefi`
        });
        ...
        Object.defineProperty(this, "authenticate", {
            ...
            value: async () => {
                ...
                this.signer = new aa_core_1.WalletClientSigner((0, viem_1.createWalletClient)({
                    transport: (0, viem_1.custom)(this.inner),
                }), this.signerType);
        ...
        this.inner = new web3_provider_1.FordefiWeb3Provider(params);
    }
}
exports.FordefiSigner = FordefiSigner;
