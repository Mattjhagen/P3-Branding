 ...
 */
export declare class PortalSigner implements SmartAccountAuthenticator<PortalAuthenticationParams, PortalUserInfo, Portal> {
    inner: Portal;
    private signer;
    constructor(params: PortalOptions | {
        inner: Portal;
    });
    readonly signerType = "aa-signers:portal";
    ...
    authenticate: () => Promise<PortalUserInfo>;
    getAuthDetails: () => Promise<PortalUserInfo>;
}
