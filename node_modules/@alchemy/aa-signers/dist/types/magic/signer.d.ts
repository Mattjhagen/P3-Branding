 ...
 */
export declare class MagicSigner implements SmartAccountAuthenticator<MagicAuthParams, MagicUserMetadata, Magic> {
    inner: Magic;
    private signer;
    constructor(params: MagicSDKParams | {
        inner: Magic;
    });
    readonly signerType = "aa-signers:magic";
    ...
    authenticate: (params: MagicAuthParams) => Promise<MagicUserMetadata>;
    getAuthDetails: () => Promise<MagicUserMetadata>;
}
