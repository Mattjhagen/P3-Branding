...
import type { FireblocksAuthenticationParams, FireblocksUserInfo } from "./types.js";
/**
 ...
 */
export declare class FireblocksSigner implements SmartAccountAuthenticator<FireblocksAuthenticationParams, FireblocksUserInfo, FireblocksWeb3Provider> {
    inner: FireblocksWeb3Provider;
    private signer;
    constructor(params: FireblocksProviderConfig | {
        inner: FireblocksWeb3Provider;
    });
    readonly signerType = "aa-signers:fireblocks";
