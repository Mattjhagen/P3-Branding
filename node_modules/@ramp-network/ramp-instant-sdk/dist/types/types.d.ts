...
export declare type WidgetVariantTypes = 'desktop' | 'mobile' | 'hosted-desktop' | 'hosted-mobile' | 'webview-desktop' | 'webview-mobile';
...
export declare type TOnSendCryptoCallback = (assetInfo: AssetInfo, amount: string, address: string) => Promise<IOnSendCryptoResult>;
export {};
