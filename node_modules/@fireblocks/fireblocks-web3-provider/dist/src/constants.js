...
exports.ASSETS = {
    ...
    [types_1.ChainId.SEPOLIA]: { assetId: 'ETH_TEST5', rpcUrl: "https://ethereum-sepolia-rpc.publicnode.com" },
    [types_1.ChainId.HOLESKY]: { assetId: 'ETH_TEST6', rpcUrl: "https://ethereum-holesky-rpc.publicnode.com" },
    [types_1.ChainId.HOODI]: { assetId: 'ETH_TEST_HOODI', rpcUrl: "https://ethereum-hoodi-rpc.publicnode.com" },
    ...
    [types_1.ChainId.POLYGON_AMOY]: { assetId: 'AMOY_POLYGON_TEST', rpcUrl: "https://rpc-amoy.polygon.technology" },
    ...
    [types_1.ChainId.ARBITRUM_SEPOLIA]: { assetId: 'ETH-AETH_SEPOLIA', rpcUrl: "https://sepolia-rollup.arbitrum.io/rpc" },
    ...
    [types_1.ChainId.OPTIMISM_SEPOLIA]: { assetId: 'ETH-OPT_SEPOLIA', rpcUrl: "https://sepolia.optimism.io/" },
    ...
    [types_1.ChainId.BASE_SEPOLIA]: { assetId: 'BASECHAIN_ETH_TEST5', rpcUrl: "https://sepolia.base.org" },
    ...
    [types_1.ChainId.LINEA_SEPOLIA_TEST]: { assetId: 'LINEA_SEPOLIA_TEST', rpcUrl: "https://rpc.sepolia.linea.build" },
    [types_1.ChainId.FLARE]: { assetId: 'FLR', rpcUrl: "https://flare-api.flare.network/ext/C/rpc" },
    [types_1.ChainId.MANTLE]: { assetId: 'MANTLE', rpcUrl: "https://rpc.mantle.xyz" },
    [types_1.ChainId.MANTLE_TEST]: { assetId: 'MANTLE_TEST', rpcUrl: "https://rpc.testnet.mantle.xyz" },
    [types_1.ChainId.BLAST]: { assetId: 'BLAST', rpcUrl: "https://rpc.ankr.com/blast" },
    // [ChainId.BLAST_SEPOLIA]: { assetId: 'BLAST_TEST', rpcUrl: "https://sepolia.blast.io"},
    [types_1.ChainId.SONEIUM]: { assetId: 'ETH_SONEIUM', rpcUrl: "https://rpc.soneium.org/" },
    ...
    [types_1.ChainId.HYPER_EVM]: { assetId: 'HYPE_ETH', rpcUrl: "https://rpc.hyperliquid.xyz/evm" },
    [types_1.ChainId.HYPER_EVM_TEST]: { assetId: 'HYPE_ETH_TEST', rpcUrl: "https://rpc.hyperliquid-testnet.xyz/evm" },
    [types_1.ChainId.ABSTRACT]: { assetId: 'ABSTRACT_ETH', rpcUrl: "https://api.mainnet.abs.xyz" },
    [types_1.ChainId.UNICHAIN]: { assetId: 'UNICHAIN_ETH', rpcUrl: "https://mainnet.unichain.org" },
    [types_1.ChainId.BERACHAIN]: { assetId: 'BERACHAIN', rpcUrl: "https://rpc.berachain.com" },
    [types_1.ChainId.SONIC]: { assetId: 'SONIC', rpcUrl: "https://rpc.soniclabs.com" },
    [types_1.ChainId.GNOSIS]: { assetId: 'XDAI', rpcUrl: "https://rpc.gnosischain.com" },
    [types_1.ChainId.WORLDCHAIN]: { assetId: 'WORLDCHAIN', rpcUrl: "https://worldchain.drpc.org" },
};
