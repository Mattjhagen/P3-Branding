 ...
 */
export declare const signTypedData: <T extends EIP712TypedData>(signer: LitTypeDataSigner, msgParams: string | T) => Promise<ETHSignature>;
/**
 ...
 */
export declare const signTypedDataLegacy: <T>(signer: LitTypeDataSigner, msgParams: any) => Promise<ETHSignature>;
/**
...
export declare function getTypedDataVersionInfo({ signer, payload }: ETHHandlerReq): {
    ...
    info: {
        ...
        signTypedDataFn: <T extends EIP712TypedData>(signer: LitTypeDataSigner, msgParams: string | T) => Promise<string>;
    };
};
/**
 ...
 * @throws {Error} If the addresses do not match or if the signature is invalid.
 */
export declare const personalSignHandler: ({ signer, payload, }: ETHHandlerReq) => Promise<ETHHandlerRes>;
/**
