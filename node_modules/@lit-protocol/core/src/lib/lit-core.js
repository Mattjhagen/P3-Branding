    ...
    constructor(args) {
        ...
        this.sendCommandToNode = async ({ url, data, requestId, }) => {
            ...
            return fetch(url, req)
                ...
                .catch((error) => {
                console.error(`Something went wrong, internal id for request: lit_${requestId}. Please provide this identifier with any support requests. ${error?.message || error?.details
