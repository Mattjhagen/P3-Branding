...
export declare class LitNodeClientNodeJs extends LitCore {
     ...
     */
    static generateSessionCapabilityObjectWithWildcards: (litResources: Array<ILitResource>) => ISessionCapabilityObject;
